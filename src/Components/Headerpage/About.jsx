...
function About() {
    return (
        <section className='flex justify-evenly p-10 Mobile-S:flex-col Mobile-S:p-5'>
            <div>
                <h3 className='font-Sora font-semibold text-8xl Mobile-S:text-5xl'>About Us</h3>
                <div className='h-3 bg-gradient-to-r from-Orange to-white'></div>
            </div>
            <p className='font-Sora font-extralight text-2xl w-2/5 text-slate-600 Mobile-S:w-full Mobile-S:mt-2 Mobile-S:text-sm'>
